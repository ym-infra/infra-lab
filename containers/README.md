...
| ファイル | 内容 |
| --- | --- |
| [README.md](./zabbix/README.md) | 環境と目次 |
| [01-setup.md](./zabbix/01-setup.md) | Zabbix サーバの構築（コンテナを使わず手動で） |
| [02-webui.md](./zabbix/02-webui.md) | 設定ファイルと Web UI の分担、画面の基本操作 |
| [03-agent.md](./zabbix/03-agent.md) | 監視対象の追加。パッシブとアクティブの違い |
| [04-http.md](./zabbix/04-http.md) | HTTP 監視（Web シナリオ）とトリガー |
| [05-docker.md](./zabbix/05-docker.md) | Docker 監視と LLD（ローレベルディスカバリ） |
| [06-cert.md](./zabbix/06-cert.md) | SSL 証明書監視。前段での TLS 終端 |
| [99-troubleshooting.md](./zabbix/99-troubleshooting.md) | つまずいた点と、切り分けに使った手法 |
